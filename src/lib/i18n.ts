...
const en: Dict = {
  ...
  "backup.today": "Last backup: today.",
  "backup.last": "Last backup: {days} day(s) ago.",
  "backup.stale": "Last backup was {days} days ago — time for a fresh one.",
  "backup.never": "You haven't backed up yet — download a backup to keep your data safe.",
  ...
  "nav.logout": "Log out",
  "history.subtitle": "Every change to your business records, most recent first.",
  "history.empty": "No activity yet",
  "history.emptyDesc": "Actions you take — sales, payments, edits and deletions — will be logged here.",
  "history.sale": "Activity",
...
const ha: Dict = {
  ...
  "backup.done": "An sauke ajiya",
  "backup.today": "Ajiyar ƙarshe: yau.",
  "backup.last": "Ajiyar ƙarshe: kwana {days} da suka wuce.",
  "backup.stale": "Ajiyar ƙarshe kwana {days} da suka wuce — lokaci ya yi na sabo.",
  "backup.never": "Ba ka yi ajiya ba tukuna — sauke ajiya don kare bayananka.",
  ...
  "nav.logout": "Fita",
  "history.subtitle": "Duk canje-canjen bayanan kasuwancinka, sabo na farko.",
  "history.empty": "Babu ayyuka tukuna",
  "history.emptyDesc": "Ayyukan da ka yi — tallace-tallace, biya, gyare-gyare da sharewa — za a rubuta su anan.",
  "history.sale": "Ayyuka",
